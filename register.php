        ...
        <section class="form-container">
            ...
            <form action="" method="post">
                <div class="input-field">
                    <p>your name</p>
                    <input type="text" name="name" required placeholder="enter your name.." maxlengh="50">
                </div>
                <div class="input-field">
                    <p>your email</p>
                ...
                <div class="input-field">
                    ...
                    <input type="text" name="cpass" required placeholder="enter your password.." maxlengh="50"
                    oninput="this.value= this.value.replace(/\s/g,'')">
                </div>
